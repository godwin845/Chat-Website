        ...
        <div className='h-full w-auto px-1'>
            <div className='flex justify-between gap-2'>
                <form onSubmit={handelSearchSubmit} className='w-auto flex items-center justify-between bg-white rounded-full '>
                    ...
                    />
                    <button className='btn btn-circle bg-green-800 hover:bg-gray-950'>
                        <FaSearch />
                    </button>
                </form>
                <img
                                ...
                                <div key={user._id}>
                                    <div
                                        ...
                                        className={`flex gap-3 
                                                ...
                                                ${selectedUserId === user?._id ? 'bg-green-800' : ''
                                            } `}>
                                        {/*Socket is Online*/}
                                        <div className={`avatar ${isOnline[index] ? 'online':''}`}>
                                            <div className="w-12 rounded-full">
                                                <img src={user.profilepic} alt='user.img' />
                                            </div>    const { messages, selectedConversation, setMessage, setSelectedConversation } = userConversation();
